...
#include <linux/i2c/pcf857x.h>	/* io-expand chip */
...
#define IS_SUNXI_PIN(pin)		(((pin) < AXP_PIN_BASE) && ((pin) > 0))
#define IS_AXP_PIN(pin)			(((pin) >= AXP_PIN_BASE) && ((pin) < IO_EXP_PIN_BASE))
#define IS_IO_EXP_PIN(pin)		((pin) >= IO_EXP_PIN_BASE)
...
#define GPIO_IO_EXP(n)	(IO_EXP_PIN_BASE  + (n))
