 ...
 */
#ifndef __MEM_CCMU_SUNIVW1P1_H__
#define __MEM_CCMU_SUNIVW1P1_H__
...
typedef union {
	...
	struct {
		...
		__u32 CpuClkSrc:2;	/*bit16, CPU1/2/3/4 clock source select, 00-internal LOSC, 01-OSC24M, 10/11-PLL1 */
...
typedef union {
	...
	struct {
		...
		__u32 HclkcDiv:2;		/*bit16, HCLKC clock divide ratio. 00: /1, 01: /2, 10: /3, 11: /4*/
...
typedef struct __CCMU_REG_LIST {
	...
	volatile __u32 reserved208[2];	/*0x02c8 0x02cc, AHB1 module reset register 1 */
	volatile __u32 Apb1Reset;	/*0x02d0, APB1 module reset register */
} __ccmu_reg_list_t;

typedef struct _STANDBY_PLL_change_flag_T
{
	__u32 pllCpu;				//Pll1Ctl
	__u32 pllAudio;			//Pll2Ctl
	__u32 pllVideo0;			//Pll3Ctl
	__u32 pllVe;				//Pll4Ctl
	__u32 pllDram;			//Pll5Ctl	
	__u32 pllPeriph0;			//Pll6Ctl
}standby_pll_change_flag_t;


#endif				/* #ifndef __MEM_CCMU_SUNIVW1P1_H__ */
