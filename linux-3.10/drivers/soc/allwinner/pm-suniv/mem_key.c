...
__s32 mem_key_init(void)
{
	...
	KeyReg = (__mem_key_reg_t *) (IO_ADDRESS(AW_LRADC_PBASE));
...
#if 0 //ygy for long press LRADC to resume system
	KeyReg->Lradc_Ctrl = 0xFF000000 | (0x1 << 6) | (0x1 << 0);
	KeyReg->Lradc_Intc = (0x1 << 4);
	KeyReg->Lradc_Ints = (0x1 << 4);
#endif
