...
static int __init rtw_drv_entry(void)
{
	...
	DBG_8192C("sunxi_usb_enable_hcd: usbc_num = %d\n", usb_wifi_host);	
	...
	//wifi_pm_power(1);
	printk("wifi_pm_power \n");

	if (gpio_request(107, "WIFI_VDD"))
		printk("wifi_pm_power fail\n");
	else 
		printk("wifi_pm_power sucess\n");	
...
#ifdef CONFIG_PLATFORM_ARM_SUNxI
#ifndef CONFIG_RTL8723A
	DBG_8192C("sunxi_usb_disable_hcd: usbc_num = %d\n", usb_wifi_host);
	sunxi_usb_disable_hcd(usb_wifi_host);
