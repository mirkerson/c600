...
#define LCDC_TTL0_OFF			(0x070)				/*1663 do not has this reg: LCD Controller TTL0 registers offset*/
#define LCDC_TTL1_OFF			(0x074)				/*1663 do not has this reg: LCD Controller TTL1 registers offset*/
#define LCDC_TTL2_OFF			(0x078)				/*1663 do not has this reg: LCD Controller TTL2 registers offset*/
#define LCDC_TTL3_OFF			(0x07c)				/*1663 do not has this reg: LCD Controller TTL3 registers offset*/
#define LCDC_TTL4_OFF			(0x080)				/*1663 do not has this reg: LCD Controller TTL4 registers offset*/
#define LCDC_LVDS_OFF			(0x084)				/*1663 do not has this reg: LCD Controller LVDS registers offset*/
...
#define LCDC_TCON1_CTRL			(0x90)
#define LCDC_TCON1_BASIC0		(0x94)
#define LCDC_TCON1_BASIC1		(0x98)
#define LCDC_TCON1_BASIC2		(0x9c)
#define LCDC_TCON1_BASIC3		(0xa0)
#define LCDC_TCON1_BASIC4		(0xa4)
#define LCDC_TCON1_BASIC5		(0xa8)
