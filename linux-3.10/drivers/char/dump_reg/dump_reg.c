...
#define SUNXI_IO_PHYS_BASE      0x01c00000UL
#define SUNXI_IO_SIZE           SZ_4M          /* 4MB(Max) */
#else
#define SUNXI_IO_PHYS_BASE      0x01000000UL
#define SUNXI_IO_SIZE           SZ_16M          /* 16MB(Max) */
#endif

#define IO_PHYS_TO_VIRT_ADDR(x) 		((x) + 0xf0000000)
...
static const struct dump_struct dump_table[] = {
	...
	{IO_PHYS_TO_VIRT_ADDR(SUNXI_IO_PHYS_BASE),      IO_PHYS_TO_VIRT_ADDR(SUNXI_IO_PHYS_BASE) + SUNXI_IO_SIZE,    NULL,   NULL,       NULL,       GET_VADDR,  READ,   WRITE},
	{SUNXI_MEM_PHYS_VASE,   SUNXI_MEM_PHYS_VASE + SZ_1G,            NULL,   NULL,       NULL,       GET_VADDR,  READ,   WRITE},
};
#else
static const struct dump_struct dump_table[] = {
	{SUNXI_IO_PHYS_BASE,    SUNXI_IO_PHYS_BASE + SUNXI_IO_SIZE,     NULL,   REMAPIO,    UNMAPIO,    GET_VADDR,  READ,   WRITE},
