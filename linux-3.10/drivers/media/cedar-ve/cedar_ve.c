...
#if 0
	printk("cedar-ve func: %s the ve_base_addr:%p, vma_start:%lx, vma_end:%lx, vm_pgoff:%lx\n",
...
static int cedardev_init(struct platform_device *pdev)
{
	...
	printk("cedar-ve the get irq is %d\n", cedar_devp->irq);
	if (cedar_devp->irq <= 0)
	...
	//printk("cedar-ve get ve virtual ve regs_macc is %p\n",cedar_devp->iomap_addrs.regs_macc);
	...
	printk("cedar-ve clk_bass_vir 0x18  is %p, the value:%x\n",(cedar_devp->clk_bass_vir+6), (*(cedar_devp->clk_bass_vir+6)));
	printk("cedar-ve clk_bass_vir 0x13c  is %p, the value:%x\n",(cedar_devp->clk_bass_vir+79), (*(cedar_devp->clk_bass_vir+79)));
	printk("cedar-ve clk_bass_vir 0x64  is %p, the value:%x\n",(cedar_devp->clk_bass_vir+25), (*(cedar_devp->clk_bass_vir+25)));
	printk("cedar-ve clk_bass_vir 0x2c4  is %p, the value:%x\n",(cedar_devp->clk_bass_vir+177), (*(cedar_devp->clk_bass_vir+177)));
	printk("cedar-ve clk_bass_vir 0x100  is %p, the value:%x\n",(cedar_devp->clk_bass_vir+64), (*(cedar_devp->clk_bass_vir+64)));
