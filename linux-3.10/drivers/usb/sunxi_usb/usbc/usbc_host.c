...
static void __USBC_Host_ep0_ConfigEp(void __iomem * usbc_base_addr, __u32 ts_mode, __u32 interval)
{
	//--<1>--config ep0 csr
	USBC_Writew(1<<USBC_BP_CSR0_H_FlushFIFO, USBC_REG_CSR0(usbc_base_addr));
	__USBC_Host_ep0_DisablePing(usbc_base_addr);
...
static void __USBC_Host_Tx_EpType(void __iomem * usbc_base_addr, __u32 ep_index, __u32 ts_mode, __u32 ts_type)
{
	__u32 reg_val = 0;
...
static void __USBC_Host_Tx_ConfigEp(void __iomem * usbc_base_addr, __u32 ep_index, __u32 ts_mode, __u32 ts_type, __u32 is_double_fifo, __u32 ep_MaxPkt, __u32 interval)
{
	__u16 reg_val = 0;
	__u16 temp = 0;
...
static void __USBC_Host_Rx_EpType(void __iomem * usbc_base_addr, __u32 ep_index, __u32 ts_mode, __u32 ts_type)
{
	__u32 reg_val = 0;
...
static void __USBC_Host_Rx_ConfigEp(void __iomem * usbc_base_addr, __u32 ep_index, __u32 ts_mode, __u32 ts_type, __u32 is_double_fifo, __u32 ep_MaxPkt, __u32 interval)
{
	__u16 reg_val = 0;
	__u16 temp = 0;
...
static __s32 __USBC_Host_ReadDataHalf(void __iomem * usbc_base_addr, __u32 ep_type)
{
	switch(ep_type) {
	case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Host_ReadDataComplete(void __iomem * usbc_base_addr, __u32 ep_type)
{
	switch(ep_type) {
	case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Host_WriteDataHalf(void __iomem * usbc_base_addr, __u32 ep_type)
{
	switch(ep_type) {
	case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Host_WriteDataComplete(void __iomem * usbc_base_addr, __u32 ep_type)
{
	switch(ep_type) {
	case USBC_EP_TYPE_EP0:
