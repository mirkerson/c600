...
static void __USBC_Dev_Tx_ConfigEp(void __iomem *usbc_base_addr, __u32 ts_type, __u32 is_double_fifo, __u32 ep_MaxPkt)
{
	__u16 reg_val = 0;
	__u16 temp = 0;
...
static __u32 __USBC_Dev_Tx_IsWriteDataReady_FifoEmpty(void __iomem *usbc_base_addr)
{
	__u32 temp = 0;
...
/*
static __u32 __USBC_Dev_Tx_IsEpIncomp(void __iomem *usbc_base_addr)
{
	return USBC_REG_test_bit_w(USBC_BP_TXCSR_D_INCOMPLETE, USBC_REG_TXCSR(usbc_base_addr));
}

static void __USBC_Dev_Tx_ClearIncomp(void __iomem *usbc_base_addr)
{
...
static void __USBC_Dev_Rx_ConfigEp(void __iomem *usbc_base_addr, __u32 ts_type, __u32 is_double_fifo, __u32 ep_MaxPkt)
{
	__u16 reg_val = 0;
	__u16 temp = 0;
...
static __s32 __USBC_Dev_WriteDataHalf(void __iomem *usbc_base_addr, __u32 ep_type)
{
	switch(ep_type) {
	case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Dev_WriteDataComplete(void __iomem *usbc_base_addr, __u32 ep_type)
{
	switch(ep_type) {
	case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Dev_ReadDataHalf(void __iomem *usbc_base_addr, __u32 ep_type)
{
	switch(ep_type) {
	case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Dev_ReadDataComplete(void __iomem *usbc_base_addr, __u32 ep_type)
{
	switch(ep_type) {
	case USBC_EP_TYPE_EP0:
