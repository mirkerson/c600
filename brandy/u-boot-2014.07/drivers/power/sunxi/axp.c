...
static sunxi_axp_dev_t  *sunxi_axp_dev[SUNXI_AXP_DEV_MAX] = {(void *)(-1)};
...
int axp_set_all_limit(void)
{
	...
	fdt_getprop_u32(working_fdt,pmu_nodeoffset,"pmu_ac_vol", (uint32_t*)&gd->limit_vol);
	fdt_getprop_u32(working_fdt,pmu_nodeoffset,"pmu_ac_cur", (uint32_t*)&gd->limit_cur);
	fdt_getprop_u32(working_fdt,pmu_nodeoffset,"pmu_usbpc_vol", (uint32_t*)&gd->limit_pcvol);
	fdt_getprop_u32(working_fdt,pmu_nodeoffset,"pmu_usbpc_cur", (uint32_t*)&gd->limit_pccur);
