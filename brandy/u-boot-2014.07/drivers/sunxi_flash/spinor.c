...
static int sunxi_flash_spinor_erase_block(unsigned int block)//suwenrong
{
	return spinor_erase_block(block);
}
...
int spinor_init_for_boot(int workmode, int spino)
{
	...
	sunxi_flash_write_pt = sunxi_flash_spinor_write;
   	sunxi_flash_erase_pt = sunxi_flash_spinor_erase_block;//suwenrong
