...
struct sunxi_lradc {
	volatile unsigned int ctrl;         /* lradc control */
	volatile unsigned int intc;         /* interrupt control */
	volatile unsigned int ints;         /* interrupt status */
	volatile unsigned int data;        /* lradc 0 data */
};
