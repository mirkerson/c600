...
{
    {
        ...
        BOOT0_MAGIC,       		//magic
        STAMP_VALUE,			//check_sun		
#ifdef ALIGN_SIZE_8K
        0x2000,					//lenght
#else
        0x4000,
#endif
        sizeof( boot_file_head_t ),			//pub_head_size	
        BOOT_PUB_HEAD_VERSION,		//pub_head_vsn
        CONFIG_BOOT0_RET_ADDR,		//ret_addr
        CONFIG_BOOT0_RUN_ADDR,		//run_addr
        0,								//eGON_vsn
        {
