...
/*BEGINE: modified by oujunxi, 2015/09/17, pointer has something wrong, you have to use writel/readl*/
	timer_reg->tirqen  = 0;
	timer_reg->tirqsta |= 0x07;
	/* start avs as counter */
	//ccm_reg->avs_clk_cfg |= (1 << 31);
	
	/* div cnt0 12000 to 6000hz, high 32 bit means 1000hz.*/
	/* div cnt 1 12 to 2000000hz ,high 32 bit means 1000000hz */
	timer_reg->avs.div   = 0xc7ff;							/*uknow 4 c500s*/
