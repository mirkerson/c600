...
typedef struct
{
    ...
    unsigned int      src_burst_length : 1;            //å‘èµ·ä¸€æ¬¡burstå®½åº¦ 0:1   1:4   2:8
    unsigned int      src_data_width   : 2;            //æ•°æ®ä¼ è¾“å®½åº¦ï¼?:ä¸€æ¬¡ä¼ è¾?bitï¼?:ä¸€æ¬¡ä¼ è¾?6bitï¼?:ä¸€æ¬¡ä¼ è¾?2bitï¼?:ä¿ç•™
    ...
    unsigned int      dst_burst_length : 1;            //å‘èµ·ä¸€æ¬¡burstå®½åº¦ å¡?å¯¹åº”äº?ï¼Œå¡«1å¯¹åº”äº?,
    unsigned int      dst_data_width   : 2;            //æ•°æ®ä¼ è¾“å®½åº¦ï¼?:ä¸€æ¬¡ä¼ è¾?bitï¼?:ä¸€æ¬¡ä¼ è¾?6bitï¼?:ä¸€æ¬¡ä¼ è¾?2bitï¼?:ä¿ç•™
