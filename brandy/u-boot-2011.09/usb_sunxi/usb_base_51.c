...
int sunxi_usb_init(int delaytime)
{
	...
	usb_recv_by_dma.cfg.src_drq_type     = 0b11100;  //OTG EP2
	usb_recv_by_dma.cfg.src_addr_type= DMAC_CFG_SRC_ADDR_TYPE_IO_MODE;
	...
	usb_recv_by_dma.cfg.dst_drq_type     = 0b10110;  //DRAM
	usb_recv_by_dma.cfg.dst_addr_type    = DMAC_CFG_DEST_ADDR_TYPE_LINEAR_MODE;
	...
	usb_send_by_dma.cfg.src_drq_type     = 0b10110;
	usb_send_by_dma.cfg.src_addr_type    = DMAC_CFG_SRC_ADDR_TYPE_LINEAR_MODE;
	...
	usb_send_by_dma.cfg.dst_drq_type     = 0b10001;  //OTG EP1
	usb_send_by_dma.cfg.dst_addr_type    = DMAC_CFG_DEST_ADDR_TYPE_IO_MODE;
