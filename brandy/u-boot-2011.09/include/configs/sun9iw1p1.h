...
#define CONFIG_TARGET_NAME      sun9iw1p1
/*
...
#define MMU_BASE_ADDRESS                 (CONFIG_SYS_SDRAM_BASE + 0x09100000)
...
#define CONFIG_SYS_SRAMA2_SIZE           (0x40000)
#define TOC0_MMU_BASE_ADDRESS		 	 (CONFIG_SYS_SRAMA2_BASE)

#define CONFIG_SBROMSW_BASE              (CONFIG_SYS_SRAMA2_BASE + 0x20000)
...
#define CONFIG_TOC0_RUN_ADDR             (0x40480)
