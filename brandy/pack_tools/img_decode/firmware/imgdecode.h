...
extern   HIMAGEITEM 	Img_OpenItem	(HIMAGE hImage, char * subType);
...
extern   uint           Img_ReadItem_Continue(HIMAGE hImage, HIMAGEITEM hItem, void *buffer, uint buffer_size, uint file_offset);

extern   int 			Img_CloseItem	(HIMAGE hImage, HIMAGEITEM hItem);

extern   void 	 		Img_Close		(HIMAGE hImage);

extern   u8           *Img_GetItem_Subname(HIMAGE hImage, int index);
//------------------------------------------------------------------------------------------------------------
// THE END !
//------------------------------------------------------------------------------------------------------------
