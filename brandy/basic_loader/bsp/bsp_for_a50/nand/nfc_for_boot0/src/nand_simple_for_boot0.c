...
************************* add one cmd to cmd list******************************
****************************************************************************/
void _3add_cmd_list(NFC_CMD_LIST *cmd,__u32 value,__u32 addr_cycle,__u8 *addr,__u8 data_fetch_flag,
					__u8 main_data_fetch,__u32 bytecnt,__u8 wait_rb_flag)
{
	cmd->addr = addr;
	cmd->addr_cycle = addr_cycle;
...
*********************translate (block + page+ sector) into 5 bytes addr***************
*****************************************************************************/
void _cal_ad3dr_in_chip(__u32 block, __u32 page, __u32 sector,__u8 *addr, __u8 cycle)
{
	__u32 row;
	__u32 column;
...
__u8 _cal_r3eal_chip(__u32 global_bank)
{
	return 0;
}

__u8 _cal_3real_rb(__u32 chip)
{
	return 0;
}
...
**********************get status**************************************
********************************************************************/
__s32 _re3ad_status(__u32 cmd_value, __u32 nBank)
{
	/*get status*/
	__u8 addr[5];
	__u32 addr_cycle;
...
***************************wait rb ready*******************************
*********************************************************************/
__s32 _wa3it_rb_ready(__u32 chip)
{
	__s32 timeout = 0xffff;
...
void _ran3dom_seed_init(void)
{

}

__u32 _cal_3random_seed(__u32 page)
{
	__u32 randomseed;
...
__s32 _rea3d_single_page(struct boot_physical_param *readop,__u8 read_mode)
{
	__s32 ret;
	__u32 k = 0;
	__u32 rb;
...
__s32 PHY_3GetDefaultParam(__u32 bank)
{
	__u32 i, j, chip = 0;// rb = 0;
	__u8 default_value[64];
	__u8 oob_buf[64];
...
__s32 PHY_Se3tDefaultParam(__u32 bank)
{
	__u8 default_value[64];
...
__s32 PHY_3ChangeMode(__u8 serial_mode)
{
...
************************************************************************************************************************
*/
__s32  PH3Y_ResetChip(__u32 nChip)
{
	__s32 ret;
	__s32 timeout = 0xffff;
...
__s32  PHY_3ReadNandId(__s32 nChip, void *pChipID)
{
	__s32 ret;
	NFC_CMD_LIST cmd;
	__u8 addr = 0;
...
__s32 PHY_3SimpleRead (struct boot_physical_param *readop)
{
	return (_read_single_page(readop,0));
}

__s32 PHY_Si3mpleRead_1K (struct boot_physical_param *readop)
{
	return (_read_single_page(readop,1));
}
...
************************************************************************************************************************
*/
__s32 PHY_3SynchBank(__u32 nBank, __u32 bMode)
{
	__s32 ret,status;
	__u32 chip;
	__u32 rb;
