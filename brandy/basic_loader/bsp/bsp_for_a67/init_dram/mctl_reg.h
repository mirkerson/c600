...
#define MC_BW_WINDOWS           (MCTL_COM_BASE + 0x90)
...
#define ZQCR0         		(MCTL_CTL_BASE + 0x00000140)
#define ZQCR1         		(MCTL_CTL_BASE + 0x00000144)
#define ZQCR2         		(MCTL_CTL_BASE + 0x00000148)
#define ZQSR0       		(MCTL_CTL_BASE + 0x0000014c)
#define ZQSR1       		(MCTL_CTL_BASE + 0x00000150)
...
#define ACBDLR       		(MCTL_CTL_BASE + 0x00000204)
#define ACIOCR       		(MCTL_CTL_BASE + 0x00000208)
#define DXnMDLR(x)			(MCTL_CTL_BASE + 0x00000300 + 0x80 * x)			//x from 0 to 3
#define DXMDLR0             (MCTL_CTL_BASE + 0x00000300)
#define DXMDLR1             (MCTL_CTL_BASE + 0x00000380)
...
#define _CCM_PLL_DDR0_PATTERN_REG	    (_CCM_BASE+0x290)
#define _CCM_PLL_DDR1_PATTERN_REG	    (_CCM_BASE+0x2AC)
