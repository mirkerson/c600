...
#define CCMU_PLL_C0CPUX_CTRL_REG            (CCMU_REGS_BASE + 0x00)
#define CCMU_PLL_C1CPUX_CTRL_REG            (CCMU_REGS_BASE + 0x04)
#define CCMU_PLL_PERIPH_CTRL_REG            (CCMU_REGS_BASE + 0x28)
#define CCMU_PLL_HSIC_CTRL_REG              (CCMU_REGS_BASE + 0x44)


#define CCMU_CPUX_AXI_CFG_REG               (CCMU_REGS_BASE + 0x50)
#define CCMU_AHB1_APB1_CFG_REG              (CCMU_REGS_BASE + 0x54)
#define CCMU_APB2_CFG_GREG                  (CCMU_REGS_BASE + 0x58)
#define CCMU_AHB2_CFG_GREG                  (CCMU_REGS_BASE + 0x5C)

#define CCMU_BUS_CLK_GATING_REG0            (CCMU_REGS_BASE + 0x60)
#define CCMU_CCI400_CFG_REG                 (CCMU_REGS_BASE + 0x78)
#define CCMU_MBUS_RST_REG                   (CCMU_REGS_BASE + 0xFC)

#define CCMU_MBUS_CLK_REG                   (CCMU_REGS_BASE + 0x15C)
#define CCMU_PLL_STB_STATUS_REG             (CCMU_REGS_BASE + 0x20C)
#define CCMU_BUS_SOFT_RST_REG0              (CCMU_REGS_BASE + 0x2C0)

#define CCMU_AVS_CLK_REG                    (CCMU_REGS_BASE + 0x144)
#define CCMU_PLL_C0CPUX_BIAS_REG            (CCMU_REGS_BASE + 0x220)

#define CCMU_REG_AHB1_GATING0			    (CCMU_BUS_CLK_GATING_REG0)
#define CCMU_REG_AHB1_RESET0                (CCMU_BUS_SOFT_RST_REG0)

#define CCMU_REG_SD_MMC0                    (CCMU_REGS_BASE + 0x88)  //clk reg                   
#define CCMU_REG_SD_MMC2                    (CCMU_REGS_BASE + 0x90)  //clk reg
