...
#define ZQnPR(x)       		(MCTL_CTL_BASE + 0x00000144 +0x10 * x)
#define ZQnDR(x)       		(MCTL_CTL_BASE + 0x00000148 +0x10 * x)
#define ZQnSR(x)       		(MCTL_CTL_BASE + 0x0000014c +0x10 * x)
...
#define CAIOCR(x)      		(MCTL_CTL_BASE + 0x00000210 + 0x4 * (x))
...
#define PATTERN_CTL_REG         (_CCM_BASE+0x290)
